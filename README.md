...
- **Simple APIs**: Easy-to-use [HTTP API](https://rqlite.io/docs/api/). A [built-in console app](https://rqlite.io/docs/ui/), [CLI](https://rqlite.io/docs/cli/) and [client libraries](https://rqlite.io/docs/api/client-libraries/) are also available.
